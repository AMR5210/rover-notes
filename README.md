...
The Azure deployment path has been run end to end from GitHub Actions: the workflow builds
the three images, pushes them to Azure Container Registry and applies the Bicep stack to
Container Apps. The validated run completed in 7m 48s, and the API booted against
PostgreSQL Flexible Server with all migrations applied.
